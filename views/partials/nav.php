      ...
      <div class="hidden md:block">
        <div class="ml-4 flex items-center md:ml-6">
          ...
          <div class="relative ml-3">
            <div>
              <?php if (isset($_SESSION['user']) && isset($_SESSION['user']['email'])): ?>
                <a href="/" class="<?= urlIs('/') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' ?> rounded-md px-3 py-2 text-sm font-medium">Welcome <?= $_SESSION['user']['name'] ?></a>
                <?php else: ?>
                  <a href="/register" class="bg-gray-900 text-white text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Register an account</a>
              <?php endif; ?>
            </div>
          </div>
        </div>
