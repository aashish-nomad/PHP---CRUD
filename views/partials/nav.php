          ...
          <div class="relative ml-3">
            <div>
              <?php if (isset($_SESSION['user']) && isset($_SESSION['user']['email'])): ?>
                <a href="/" class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Welcome <?= $_SESSION['user']['name'] ?></a>
                <form action="/session" method="POST" class="inline-block">
